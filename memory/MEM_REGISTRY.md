...
| MEM-36 | ACTIVE | 2026-09-22 | semantic/flowbrew-platform-bugs-open.md:53 | see semantic/flowbrew-platform-bugs-open.md — MCP create_trigger_instance/list_trigger_instances outputSchema missing metadata field despite PR#221/v0.2.47 |
| MEM-37 | ACTIVE | 2026-09-22 | semantic/flowbrew-platform-bugs-open.md:58 | see semantic/flowbrew-platform-bugs-open.md — publicEndpointUrl GET workaround for real inbound SMTP address |
| MEM-38 | ACTIVE | 2026-09-22 | semantic/flowbrew-platform-bugs-open.md:74 | see semantic/flowbrew-platform-bugs-open.md — staging triggers.staging.flowbrew.app has no MX record, bug 01M3547ADJ13JH99R04FA3P1CA |
